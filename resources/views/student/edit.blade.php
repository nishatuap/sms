    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('student/update',$data->id) }}">
                ...
                <div class="form-group row">
                    <label for="department_id" class="col-md-4 col-form-label text-md-right">Course</label>
                ...
                <div class="form-group row">
                    <label for="classes_id" class="col-md-4 col-form-label text-md-right">Semester</label>
                ...
                <div class="form-group row">
                    <label for="roll" class="col-md-4 col-form-label text-md-right">Reg ID</label>
